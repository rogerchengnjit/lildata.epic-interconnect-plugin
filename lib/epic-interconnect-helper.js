...
export default class EPICInterconnect {
  ...
  RetrieveProtocolDefResponse(study) {
    const sc = [
        {
          code: {code: "PI"},
          value: { code: study.pi.toUpperCase(), codeSystem: "KID"}
        },
        {
          code: {code: "NCT"},
          value: { value: study.nct}
        },
        {
          code: {code: "IRB"},
          value: { value: study.irb}
        },
        {
          code: {code: "DEPT"},
          value: { value: study.dept}
        },
        {
          code: {code: "TYPE"},
          value: { value: study.type}
        }
      ];

    _.each(study.coords, k => {
      sc.push({ 
        code: {code: "COORD"},
    ...
    return {
      ...
      id: study.id,
      title: study.title.replace(/\]/i,')').replace(/\[/i,'('),
      text: study.text,
